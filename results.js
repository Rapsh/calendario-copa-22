...
document.querySelector("#game-results").innerHTML = 
   createCard("20/11", "domingo", createGame("qatar",0,0,"ecuador")
   )+
   createCard("21/11", "segunda", 
   createGame("england",0,0,"iran")+
   createGame("senegal",0,0,"netherlands")+
   createGame("united-states",0,0,"wales")
   )+

   createCard("22/11", "terça", 
   createGame("argentina",0,0,"saudi-arabia")+
   ...
   createGame("germany",0,0,"japan")+
   createGame("spain",0,0,"costa-rica")+
   createGame("belgium",0,0,"canada")
   )+

   createCard("24/11","quinta", 
    createGame("switzerland", 0,0, "cameroon") +
    createGame("uruguay", 0,0, "southk") +
    createGame("portugal", 0,0, "ghana") +
    createGame("brazil", 0,0, "serbia") 
    )+

   createCard("25/11","sexta", 
    createGame("wales", 0,0, "iran") +
    createGame("qatar", 0,0, "senegal") +
    createGame("netherlands", 0,0, "ecuador") +
    createGame("england", 0,0, "united-states") 
    )+

   createCard("26/11","sabado", 
    createGame("tunisia", 0,0, "australia") +
    createGame("poland", 0,0,"saudi-arabia") +
    createGame("france", 0,0,"denmark") +
    createGame("argentina", 0,0,"mexico") 
    )+

   createCard("27/11","domingo", 
    createGame("japan", 0,0,"costa-rica") +
    createGame("belgium", 0,0,"morocco") +
    createGame("croatia", 0,0,"canada") +
    createGame("spain", 0,0,"germany") 
    )+
    
   createCard("28/11", "segunda", 
    createGame('cameroon', 0,0, 'serbia') +
